...
cmd = "cd \"#{dir}\"; #{ENV['TM_PHPUNIT'] || 'phpunit'} --log-junit /tmp/#{file}.xml --filter #{test_name} #{file} > /tmp/#{file}.log; cat /tmp/#{file}.xml; echo \"=log=\"; cat /tmp/#{file}.log; rm /tmp/#{file}.xml; rm /tmp/#{file}.log;"
